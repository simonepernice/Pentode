...
public final class RadialShading extends Shading {
     ...
     * @param coords  the coordinates {@code (x1, y1, r1, x2, y2, r2)}.
     * @param function  the interpolation function ({@code null} not 
     *     permitted).
     */
    ...
    /**
     * Sets the array containing the coordinates {@code (x1, y1, r1, x2, y2, 
     * r2)} of the starting circle and the ending circle.
     * 
     * @param coords  the circle coordinates ({@code null} not permitted).
     */
