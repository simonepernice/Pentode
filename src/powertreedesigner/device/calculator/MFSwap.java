 ...
 */
public class MFSwap extends MathFunction {

    public MFSwap() {
        super("swap", 2, "swaps the last two vectors from the stack");
    }

    @Override
    public void calculate(Stack<VectorOfDouble> stack) throws CalculationException {
            VectorOfDouble sh1 = stack.pop();
            VectorOfDouble sh2 = stack.pop();
            stack.push(sh1);
            stack.push(sh2);
    }
