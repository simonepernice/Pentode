...
public class If extends Command {
    static {
        LinesToParse.addIterationCommand("if", "iEnd");
    }    

    public If() {
        super("if", "command conditional if");
    ...
    public String getHelp() {
        return super.getHelp()+"-Function = defines the begin of the block if condition / iEnd. The block is executed only if the condition after if is not 0. To enter a multi line statement in interactive mode ends the lines with symbol +\n";
    }      
